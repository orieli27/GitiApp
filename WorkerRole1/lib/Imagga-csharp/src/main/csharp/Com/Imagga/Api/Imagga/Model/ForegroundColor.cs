...
namespace Com.Imagga.Api.Imagga.Model
{
    ...
    /// <summary>
    /// Model for ForegroundColor
    /// </summary>
    [DataContract]
    public class ForegroundColor : IEquatable<ForegroundColor>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ForegroundColor {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ForegroundColor);
        }

        /// <summary>
        /// Returns true if ForegroundColor instances are equal
        /// </summary>
        /// <param name="obj">Instance of ForegroundColor to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForegroundColor other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
