...
namespace Com.Imagga.Api.Imagga.Model
{
    ...
    /// <summary>
    /// Model for CategorizationResponse
    /// </summary>
    [DataContract]
    public class CategorizationResponse : IEquatable<CategorizationResponse>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CategorizationResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CategorizationResponse);
        }

        /// <summary>
        /// Returns true if CategorizationResponse instances are equal
        /// </summary>
        /// <param name="obj">Instance of CategorizationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CategorizationResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
