...
namespace Com.Imagga.Api.Imagga.Model
{
    ...
    /// <summary>
    /// Model for BackgroundColor
    /// </summary>
    [DataContract]
    public class BackgroundColor : IEquatable<BackgroundColor>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BackgroundColor);
        }

        /// <summary>
        /// Returns true if BackgroundColor instances are equal
        /// </summary>
        /// <param name="obj">Instance of BackgroundColor to be compared</param>
        /// <returns>Boolean</returns>
